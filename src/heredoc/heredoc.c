...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/29 18:18:38 by jalves-c          #+#    #+#             */
/*   Updated: 2024/01/29 18:18:39 by jalves-c         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	_check_sig_eof(t_minivault *minivault, \
			t_command *command, t_heredoc *doc, char *input)
{
	char	*cycle;
